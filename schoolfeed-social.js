...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Turn social engagement into a positive experience",
            subtitle: config.subtitle || "",
            description: config.description || "Our platform eliminates the common pitfalls of traditional social media while encouraging meaningful member-to-member interactions. With conversation prompts, leaderboards, and more, engaging with your organization becomes fun, rewarding, and safe.",
