...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            ...
            subtitle: config.subtitle || "DocMersion™ for SchoolBoards",
            description: config.description || "Turn your school district documents into digital experiences that families and staff actually want to use. From board policies and handbooks to event calendars and newsletters, DocMersion makes critical information accessible, engaging, and easy to navigate. Help your community stay informed and connected with documents that work as hard as you do.",
            ctaText: config.ctaText || "EXPLORE PLATFORM",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/document-engagement/document-engagement-hero-vector.png",
            ...
            <div class="hero-container">
                <div class="hero-main">
                    <div class="hero-content">
                        ...
                        <h2 class="hero-subtitle">${this.config.subtitle}</h2>
