...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Ultra Accessible",
            subtitle: config.subtitle || "Policies. Procedures. Documents.",
            description: config.description || "Turn your documents into digital experiences people enjoy using.",
    ...
    generateStyles() {
        ...
        <style>
            .hero-component {
                ...
                overflow: hidden;
                padding: 0;
                margin-top: 0; /* Remove extra margin - navbar loader handles this */
            }
