...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Show Your Spirit",
            subtitle: config.subtitle || "",
            description: config.description || "Bring your community's spirit to life with a custom-branded, fully integrated Spirit Shop. Strengthen engagement, foster pride, and create meaningful touchpoints that keep your community excited and connected.",
