...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "School Spirit",
            subtitle: config.subtitle || "Store & Merchandise",
            description: config.description || "Build community pride and generate revenue with a fully integrated spirit store featuring custom branded merchandise. From apparel to accessories, create lasting connections while supporting your school programs through quality products your community will love.",
            ctaText: config.ctaText || "LAUNCH YOUR STORE",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/spirit-gear/spiritgear-hero-vector.png",
