// Document Engagement Hero Component - DocMersion Platform
// Based on the provided design with blue theme and mobile responsiveness

class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Ultra Accessible Policies. Procedures. Documents.",
            subtitle: config.subtitle || "Turn your documents into digital experiences people enjoy using.",
            description: config.description || "DocMersion transforms complex policies into clear, usable resources—so your organization runs smarter, your people stay engaged, and your community thrives.",
            ctaText: config.ctaText || "Book a Demo",
                ...
                <div class="hero-main">
                    ...
                    <div class="hero-visual">
                        <div class="hero-image-container">
                            <img src="${this.config.heroImage}" alt="DocMersion Document Engagement Platform" class="hero-image" />
                        </div>
                    </div>
                </div>
