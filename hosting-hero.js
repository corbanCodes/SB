...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Secure & Reliable Hosting",
            subtitle: config.subtitle || "Built for Educational Excellence",
            description: config.description || "SchoolBlocks delivers enterprise-grade hosting designed specifically for K-12 schools. Our platform combines military-grade security, auto-scaling infrastructure, and 99.9% uptime reliability to ensure your school community stays connected when it matters most.",
            ctaText: config.ctaText || "GET STARTED",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/hosting/hosting-hero-vectorart.png",
