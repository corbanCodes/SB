...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Empowering Every Member of Your School Community",
            subtitle: config.subtitle || "",
            description: config.description || "Whether you're an administrator streamlining operations, a teacher engaging students, a parent staying connected, or a student accessing resources, SchoolBlocks serves everyone in your educational ecosystem.",
    ...
    generateStyles() {
        ...
        <style>
            .hero-component {
                ...
                overflow: hidden;
                padding: 0;
                margin-top: 0; /* No margin - navbar will overlay */
            }
            ...
            .hero-container {
                ...
                max-width: none;
                margin: 0;
                padding: 86px 20px 0 20px; /* Add top padding for navbar */
                position: relative;
                z-index: 10;
                display: flex;
