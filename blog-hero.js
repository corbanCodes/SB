...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Insights & Tips",
            subtitle: config.subtitle || "From Education Experts",
            description: config.description || "Stay informed with the latest trends, best practices, and success stories in school communications. Our blog features expert insights, practical tips, and real-world case studies to help your educational institution thrive in the digital age.",
            ctaText: config.ctaText || "READ LATEST POSTS",
            ctaUrl: config.ctaUrl || "#blog-posts",
            heroImage: config.heroImage || "Photos/Images/blog/blog-hero.png",
