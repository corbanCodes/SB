...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Insights from the World of School Technology",
            subtitle: config.subtitle || "",
            description: config.description || "Stay up-to-date with the latest trends, tips, and best practices in educational technology. Our blog features expert insights, implementation guides, and real-world strategies to help your school thrive.",
