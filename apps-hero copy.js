...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "In-Depth Analysis of School Technology Success",
            subtitle: config.subtitle || "",
            description: config.description || "Explore detailed case studies showcasing how schools have implemented SchoolBlocks solutions to solve specific challenges, improve outcomes, and drive measurable results in their communities.",
