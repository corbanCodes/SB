...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Resources to Help Your School Succeed",
            subtitle: config.subtitle || "",
            description: config.description || "Explore our comprehensive collection of insights, best practices, and success stories to help you maximize your school's technology investment and improve community engagement.",
