...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Learning Resources",
            subtitle: config.subtitle || "& Training Hub",
            description: config.description || "Master SchoolBlocks with our comprehensive library of tutorials, documentation, and expert-led training sessions. From quick-start guides to advanced customization techniques, access everything you need to maximize your platform's potential and achieve your educational goals.",
            ctaText: config.ctaText || "START LEARNING",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/Learning Resources/learning-resources-hero-vector.png",
