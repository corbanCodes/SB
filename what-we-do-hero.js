...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Community Relationship",
            subtitle: config.subtitle || "Management Platform",
            description: config.description || "SchoolBlocks provides a comprehensive platform that brings together websites, communication tools, mobile apps, and enrollment management in one unified solution. We help schools build stronger connections with their communities through innovative technology designed specifically for education.",
            ctaText: config.ctaText || "EXPLORE PLATFORM",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/what-we-do/what-we-do-hero-vector-art.png",
