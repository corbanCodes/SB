...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Comprehensive School Technology Solutions",
            subtitle: config.subtitle || "",
            description: config.description || "From websites and mobile apps to document engagement and AI-powered tools, SchoolBlocks provides everything your district needs to enhance communication, streamline operations, and engage your community.",
