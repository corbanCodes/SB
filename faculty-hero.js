...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Empower Your",
            subtitle: config.subtitle || "Greatest Asset",
            description: config.description || "Elevate your teachers and showcase their exceptional work with professional profile pages, seamless classroom management tools, and collaborative platforms. SchoolBlocks empowers faculty with the digital tools they need to excel while highlighting their vital role in the school community.",
            ctaText: config.ctaText || "DISCOVER FACULTY TOOLS",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/faculty/faculty-hero-vector.png",
