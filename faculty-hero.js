...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Empowering Your Greatest Asset",
            subtitle: config.subtitle || "",
            description: config.description || "The most important asset of any district is its teachers. That's why SchoolBlocks goes further than anyone else in highlighting teachers and the great work they do.",
