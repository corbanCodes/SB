...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Proactive Parenting",
            subtitle: config.subtitle || "",
            description: config.description || "Research consistently highlights the correlation between parental involvement and student achievement. SchoolBlocks is here to strengthen your involvement and connection.",
