...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Stay Connected",
            subtitle: config.subtitle || "Stay Informed",
            description: config.description || "Keep your family engaged with your child's education through real-time updates, assignment tracking, and seamless communication tools. SchoolBlocks empowers parents with instant access to school information, events, and their student's academic progress from any device.",
            ctaText: config.ctaText || "EXPLORE PARENT TOOLS",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/parents/parents-hero-vector.png",
