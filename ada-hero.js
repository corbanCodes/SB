...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "ADA Compliance",
            subtitle: config.subtitle || "Accessibility for All",
            description: config.description || "SchoolBlocks ensures your school website meets ADA compliance standards with built-in accessibility features. Our platform provides keyboard navigation, screen reader compatibility, and WCAG 2.2 compliance to create inclusive digital experiences for every member of your school community.",
            ctaText: config.ctaText || "GET STARTED",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/ADA compliance/adacompliance-hero-vector.png",
