...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Why ADA Compliance is Important",
            subtitle: config.subtitle || "",
            description: config.description || "Public school websites are required to be ADA compliant through Section 504 and Title II of the Americans with Disabilities Act. Figuring out what constitutes an ADA-compliant website can be difficult. That is where SchoolBlocks comes in!",
