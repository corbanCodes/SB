...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "The right app for the right occasion",
            subtitle: config.subtitle || "",
            description: config.description || "The SchoolBlocks App is free and offers a unique app experience for each school. Our app enjoys higher download rates!",
