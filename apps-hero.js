...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Empower Your Community",
            subtitle: config.subtitle || "With Helpful Apps",
            description: config.description || "SchoolBlocks delivers powerful Progressive Web App technology that transforms your school's digital presence. Our mobile-first approach creates app-like experiences that boost engagement up to 3× while providing instant access to school information, events, and communication tools.",
            ctaText: config.ctaText || "GET STARTED",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/mobile-apps/mobile-apps.png",
