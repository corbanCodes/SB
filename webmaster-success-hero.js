...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Webmaster Success",
            subtitle: config.subtitle || "School Website Excellence",
            description: config.description || "SchoolBlocks empowers webmasters to create stunning, functional school websites that engage communities and streamline communication. Our intuitive platform combines powerful design tools with deep educational expertise, helping you build digital experiences that truly serve your school community.",
            ctaText: config.ctaText || "GET STARTED",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/webmastersuccess/webmastersuccessherovectorart.png",
