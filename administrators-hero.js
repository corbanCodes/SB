...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Strategic Leadership",
            subtitle: config.subtitle || "Made Simple",
            description: config.description || "Lead with confidence using comprehensive administrative tools that streamline operations, enhance communication, and provide data-driven insights. SchoolBlocks empowers administrators with integrated platforms for managing everything from district-wide initiatives to family engagement strategies.",
            ctaText: config.ctaText || "EXPLORE ADMIN TOOLS",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/administrators/admin-hero-vector.png",
