...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Student-Centered",
            subtitle: config.subtitle || "Digital Experience",
            description: config.description || "Empower students with seamless access to school information, calendars, assignments, and resources. SchoolBlocks creates an intuitive digital environment where students can stay connected, organized, and engaged with their educational journey through mobile apps and responsive web platforms.",
            ctaText: config.ctaText || "EXPLORE STUDENT TOOLS",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/students/students-herovector.png",
