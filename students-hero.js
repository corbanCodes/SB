...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Enhancing the educational experience.",
            subtitle: config.subtitle || "",
            description: config.description || "With our industry leading integrations SchoolBlocks enhances the visibility and accessibility of educational content, information, and events that students need and want.",
