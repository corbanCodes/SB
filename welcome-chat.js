...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "AI-powered Answers for Your School",
            subtitle: config.subtitle || "WelcomeChat",
            description: config.description || "Instantly answer parent and student questions with our intelligent AI chatbot. WelcomeChat provides 24/7 support, reducing administrative workload while improving communication.",
            ctaText: config.ctaText || "Try WelcomeChat",
