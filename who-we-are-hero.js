...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Who We Are",
            subtitle: config.subtitle || "& Our Mission",
            description: config.description || "We're a passionate team of educators, developers, and innovators dedicated to transforming K-12 school communications. Founded with the belief that stronger community connections lead to better educational outcomes, we build technology that brings schools and families closer together.",
            ctaText: config.ctaText || "LEARN OUR STORY",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/Who We Are/who-we-are-hero-vector-art.png",
