...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Passionate Educators Building Better School Technology",
            subtitle: config.subtitle || "",
            description: config.description || "Founded by educators who understand the unique challenges schools face, SchoolBlocks combines deep educational expertise with innovative technology to create solutions that truly work for school communities.",
