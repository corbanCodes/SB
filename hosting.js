...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "We offer the safest, most scalable web hosting",
            subtitle: config.subtitle || "",
            description: config.description || "When you want the ultimate in website performance, security and control, choose SchoolBlocks. SchoolBlocks intentionally avoids storing all usernames and passwords.",
