...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "School Websites",
            subtitle: config.subtitle || "That Work For You",
            description: config.description || "SchoolBlocks creates modern, responsive school websites that engage your entire community. Our platform delivers beautiful design, seamless navigation, and powerful content management tools that make it easy to keep families informed and connected.",
            ctaText: config.ctaText || "GET STARTED",
            ctaUrl: config.ctaUrl || "get-started.html",
            heroImage: config.heroImage || "Photos/Images/websites/websites-hero-vector.png",
