...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Beautiful School District Websites",
            subtitle: config.subtitle || "Built for Education Excellence",
            description: config.description || "Create stunning, ADA-compliant websites that engage your school community. Our platform makes it easy to build professional sites that showcase your district's achievements and connect with families.",
