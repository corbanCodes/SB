...
class HeroComponent {
    constructor(config = {}) {
        this.config = {
            title: config.title || "Real Schools, Real Success Stories",
            subtitle: config.subtitle || "",
            description: config.description || "Discover how schools and districts across the country are using SchoolBlocks to transform their communication, engage their communities, and achieve their goals. Read inspiring stories from real educators.",
